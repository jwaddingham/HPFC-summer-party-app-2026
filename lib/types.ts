...
export interface Tournament { id: string; name: string; status: TournamentStatus; knockout_mode: 'top4' | 'quarter_finals'; third_place_playoff: boolean; created_at: string; }
