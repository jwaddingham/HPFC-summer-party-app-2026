    ...
    <div className="w-full border-2 border-ink bg-white shadow-hard overflow-hidden">
      ...
      <div className="flex flex-col">
        {leagueTable.map((team, index) => {
          const isQualifying = index < 4; // Top 4 qualify
          return (
            <div
              key={team.id}
              ...
              {isQualifying &&
              <div className="absolute left-0 top-0 bottom-0 w-1.5 bg-pitch" />
              }
              ...
              <div className="w-10 text-center font-display text-xl text-ink">
                {team.pts}
              </div>
            </div>);
