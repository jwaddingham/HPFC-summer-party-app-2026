...
export function MatchTile({
  ...
  return (
    <div
      ...
      {/* Left side: Home Team */}
      <div
        className={`flex-1 text-right ${compact ? 'text-sm' : 'text-base font-bold'} truncate pr-3`}>
      ...
      <div className="flex flex-col items-center justify-center px-4 min-w-[80px]">
        ...
        <div className="font-display text-xl text-gray-500 tracking-wider">
            {time || 'TBD'}
          </div>
        }
        ...
        <div className="text-xs font-sans font-bold text-gray-500 mt-1 uppercase">
            Pitch {pitch}
          </div>
        }
      </div>
      ...
      <div
        className={`flex-1 text-left ${compact ? 'text-sm' : 'text-base font-bold'} truncate pl-3`}>
